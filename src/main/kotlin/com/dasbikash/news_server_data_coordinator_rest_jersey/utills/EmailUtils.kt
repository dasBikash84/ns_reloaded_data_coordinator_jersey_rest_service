...
import com.dasbikash.news_server_data_coordinator_rest_jersey.exceptions.EmailSendingException
import com.dasbikash.news_server_data_coordinator_rest_jersey.model.EmailAuth
import com.dasbikash.news_server_data_coordinator_rest_jersey.model.EmailTargets
...
object EmailUtils {
    ...
    fun <T> emailAuthTokenToAdmin(authToken: AuthToken,requetingClass:Class<T>){
        sendEmail("New Token for ${requetingClass.simpleName}  of Data Coordinator Rest Service","Token:\t${authToken.token}\nExpires on:\t${authToken.expiresOn}")
    }
